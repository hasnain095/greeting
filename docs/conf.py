...
"""
greeting documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'greeting',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/greeting",
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'An app that provides greeting api',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'greeting'),
                os.path.join(root_path, 'greeting/migrations')])
