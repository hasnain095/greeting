...
VERSION = get_version('greeting', '__init__.py')
...
setup(
    name='greeting',
    version=VERSION,
    description="""An app that provides greeting api""",
    long_description=README + '\n\n' + CHANGELOG,
    author='edX',
    author_email='oscm@edx.org',
    url='https://github.com/openedx/greeting',
    ...
    entry_points={
        "lms.djangoapp": [
            "greeting = greeting.apps:GreetingConfig",
        ],
    }
)
